...
class TestTeacherSignupAPIView(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.client = APIClient()

    def test_successful_teacher_signup(self):
        url = reverse('teacher:teacher_signup')
        data = {
        ...
        with patch('courses_apps.teacher.services.teacher_signup') as mocked_teacher_signup, \
            ...
            mocked_teacher_signup.return_value = (MagicMock(), 'mocked_refresh_token')
    ...
    @patch('courses_apps.teacher.services.teacher_signup')
    def test_teacher_signup_failed(self, mocked_teacher_signup):
        mocked_teacher_signup.side_effect = ValidationError('Signup failed.')
        url = reverse('teacher:teacher_signup')
        data = {
            'full_name': 'Test Teacher',
            'email': 'test@example.com',
